...
> **⚠️ 首次打开**：右键点击 App → 选择「打开」以绕过 Gatekeeper。
> **⚠️ First launch**: Right-click the app → select "Open" to bypass Gatekeeper.
...
- 🎧 **多播放器支持** — 兼容 Apple Music、QQ 音乐、网易云音乐、Spotify 等任何使用 macOS 媒体系统的播放器
- 🎧 **Multi-player support** — Works with Apple Music, QQ Music, NetEase Cloud Music, Spotify, and any player using macOS media system
